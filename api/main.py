...
SYSTEM_PROMPT = (
    "ты помощник фермера, по готовому расчёту дай 2-4 конкретные рекомендации "
    "и одно короткое объяснение оценки простым языком, без технического жаргона, "
    "на русском. Ответь строго в JSON без markdown-обёртки: "
